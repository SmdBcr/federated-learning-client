...
consumer = KafkaConsumer (topicName, group_id = 'client3final',bootstrap_servers = bootstrap_servers,
...
URL_send = 'http://localhost:5000/api/federated/models/send/client3'
    ...
    for message in consumer:
        ...
        if (str(message.value, 'utf-8') == 'start2'):
            ...
            if (checkFirstTrain):
              ...
              second_model.save_weights("third_client_model_weights.h5")
              print("Saved third_client_model_weights to disk")
              print("----------------------------------------------------------------------")
